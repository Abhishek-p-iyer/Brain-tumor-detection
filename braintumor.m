...
figure
subplot(231);imshow(s);title('Input image');
subplot(232);imshow(inp);title('Filtered image');

subplot(233);imshow(inp);title('Bounding Box');
hold on;rectangle('Position',wantedBox,'EdgeColor','y');hold off;

subplot(234);imshow(tumor);title('tumor alone');
subplot(235);imshow(tumorOutline);title('Tumor Outline');
subplot(236);imshow(tumorOutlineInserted);title('Detected Tumor');
